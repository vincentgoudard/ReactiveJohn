...
import './main.html';
import '../tests/d3/d3-timeline/d3-timeline.js'
...
Template.hello.helpers({
  ...
  sequences() {
    // get the data from the mongo collection
	  var seq = Sequences.find({}).fetch();
    // remove the _id property
	  seq.forEach(function(v){ delete v._id });
    //return 'dump : ' + JSON.stringify(seq);
    return new John(lanes, seq, "#john_anchor_1"); 
  },
});
